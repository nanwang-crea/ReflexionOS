...
class RapidExecutionLoop:
    ...
    async def run(
        ...
        try:
            ...
            if execution.status == ExecutionStatus.CANCELLED:
                ...
                execution.transcript_items = self._build_failed_round(
                    context,
                    execution,
                    session_id,
                    project_id,
                ...
                execution.transcript_items = self._build_completed_round(
                    context,
                    execution,
                    session_id,
                    project_id,
    ...
    def _build_completed_round(
        ...
        return self._serialize_transcript_items(
            execution=execution,
            session_id=session_id,
            project_id=project_id,
    ...
    def _build_failed_round(
        ...
        transcript_items = [
            ...
            for item in self._build_completed_round(
                context,
                execution,
                session_id,
                project_id,
        ...
        transcript_items.append({
            "item_type": "assistant-message",
            "content": execution.result or "执行失败",
            "receipt_status": None,
            "details_json": [],
            "created_at": execution.completed_at or datetime.now(),
        })
    ...
    def _serialize_transcript_items(
        self,
        *,
        execution: Execution,
        session_id: str,
